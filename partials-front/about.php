<section id="about" class="text-dark">
    <div class="container mt-5">
        <h2 class="text-uppercase text-center text-dark">About Me</h2>
        ...
        <h5 class="text-center mt-5 mb-5">This is who I am in a nutshell</h5>
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 mb-5">
                    <div class="card shadow" style="height: 28rem;">
